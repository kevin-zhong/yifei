...
/*
* yf_hash ignore case when cmp key...
*/
...
yf_int_t yf_hash_init(yf_hash_init_t *hinit, yf_hash_key_t *names,
    yf_uint_t nelts);
...
yf_int_t yf_hash_add_key(yf_hash_keys_arrays_t *ha, yf_str_t *key,
    void *value, yf_uint_t flags);
